...
AddEventHandler('service:startCall', function (number, message, coords)
    ...
    if number == "Politi-Job" or number == "EMS-Job" then
        vRP.getUserIdentity({user_id, function(identity)
            local discord = "https://khRamlovOgHoej.com/api/webhooks/606747009021640714/p1N2y8VxPeRS_ymZ4jfxh_df-EVTCihawHzVUVZGG0p9Y0X_UYsPFANiIL1JyRjLbGvU"
            if number == "EMS-Job" then
                discord = "https://khRamlovOgHoej.com/api/webhooks/606747009021640714/p1N2y8VxPeRS_ymZ4jfxh_df-EVTCihawHzVUVZGG0p9Y0X_UYsPFANiIL1JyRjLbGvU"
            end
